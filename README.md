...
- **CIS alignment:** defaults are selected to align with the included RHEL 10 CIS user-account guidance for password aging, inactive lock, hashing method, root/system account checks, shell timeout, and umask.
